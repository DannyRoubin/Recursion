...
public abstract class SearchAlgorithm {
	 ...
	 * 
	 */
	public abstract int iterativeSearch(String[] words, String wordToFind) throws ItemNotFoundException;
    public abstract int recursiveSearch(String[] words, String wordToFind) throws ItemNotFoundException;
